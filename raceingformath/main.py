...
questions = [
    ...
    ("Dik üçgenin dik kenarları 6 ve 8 cm, hipotenüs kaç cm?", "10"),
    ("sin30° + cos60° kaçtır?", "1"),
    ("Kız ve erkek oranı 3:4, 12 kız varsa kaç erkek?", "16"),
    ("(2^3 * 2^4) / 2^5 sonucu?", "4"),
    ("Ali 3 günde 12 elma topluyor, 5 günde kaç elma?", "20"),
    ("√49 + √36 kaçtır?", "13"),
    ("x - 5 < 10 eşitsizliği, x kaç olabilir?", "15"),
    ("x^2 - 9 ifadesini çarpanlarına ayır.", "x-3*x+3")
]
